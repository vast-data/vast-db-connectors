...
public class TestVastSplit
{
    ...
    private final VastSplit split = new VastSplit(endpoints, context, info, TupleDomain.all());
            ...
            throws URISyntaxException
    {
        ...
        VastSplit split1 = new VastSplit(endpoints, ctx, schedulingInfo, TupleDomain.all());
        List<URI> endpoints2 = new ArrayList<>(endpoints);
        endpoints2.add(new URI("http://localhost:8080"));
        VastSplit split2 = new VastSplit(endpoints2, ctx, schedulingInfo, TupleDomain.all());
