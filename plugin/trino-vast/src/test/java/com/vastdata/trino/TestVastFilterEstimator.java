...
import com.vastdata.trino.statistics.FilterEstimator;
...
public class TestVastFilterEstimator
{
    ...
    private final VastColumnHandle vcBool = buildBool();
    private final VastColumnHandle vcTiny = buildTiny();
    private final VastColumnHandle vcSmall = buildSmall();
    private final VastColumnHandle vcInt = buildInt();
