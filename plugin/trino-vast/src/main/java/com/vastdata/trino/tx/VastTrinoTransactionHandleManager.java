...
{
    public static final BiConsumer<Boolean, UnaryOperator<Optional<String>>> ALWAYS_EMPTY_TRANSACTION = (_, f) -> f.apply(
            Optional.empty());
    ...
    @Inject
    public VastTrinoTransactionHandleManager(VastClient client,
                                             VastQueryEngineClient vastQueryEngineClient,
                                             VastTransactionHandleFactory transactionInstantiationFunction)
    {
        super(client, Optional.of(vastQueryEngineClient),
