        ...
        implements ConnectorTableHandle
{
    ...
    {
        return format("%s:%s@%s:complex=%s:limit=%s:sorted_by@[%s]", schemaName, tableName, predicate, complexPredicate ,limit.map(value -> format("%d", value)).orElse("none"), getSortedColumns());
    }
