...
class TrinoRowIDTypeFactory
        implements RowIDStrategyTypeFactory<VastTableHandle>
{
    ...
    {
        return SortedColumnsBasedRowIDTypeFactory.get(
                TRINO_SORTED_COLUMNS_FUNCTION, vastTableHandle);
    }
}
