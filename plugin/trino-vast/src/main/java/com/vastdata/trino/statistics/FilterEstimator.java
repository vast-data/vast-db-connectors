...
public final class FilterEstimator
{
                                         ...
                                         double limit)
    {
        ...
        ColumnStatistics colStats = statistics.getColumnStatistics().get(col);
        if (null == colStats) {
            return dom;
        }
        double nulls = 0;
    ...
    public static TupleDomain<VastColumnHandle> simplifyFilters(final TupleDomain<VastColumnHandle> tupleDomiain,
