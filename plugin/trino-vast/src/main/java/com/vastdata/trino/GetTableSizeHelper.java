...
public class GetTableSizeHelper
{
                                            ...
                                            final ConnectorSession session)
    {
        ...
        final VastSplitContext getSizeContext = new VastSplitContext(0xffffffffL - 3, 1, 1, rowGroupsPerSubSplit);
        final VastSplit split = new VastSplit(endpoints, getSizeContext, schedulingInfo, predicates);
        ...
        final Supplier<QueryDataResponseParser> fetchPages = () -> {
            ...
            QueryDataResponseSchemaConstructor.deconstruct(getTraceStr(table, token), new Schema(emptyList()), emptyList(), new LinkedHashMap<>());
    ...
    private static String getTraceStr(VastTableHandle table, VastTraceToken token)
    {
