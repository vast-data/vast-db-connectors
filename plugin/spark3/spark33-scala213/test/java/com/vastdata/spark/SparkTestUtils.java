...
import static spark.sql.catalog.ndb.SparkConfigurationCheck.SETTING_SPARK_MAX_FAILURES;
import static spark.sql.catalog.ndb.SparkConfigurationCheck.SETTING_SPARK_SPECULATION;
