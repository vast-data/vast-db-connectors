...
public class TestSparkPredicateSerializer
{
    ...
    public void testDecimal()
    {
        ...
        scala.math.BigDecimal scalaBigDecimal = scala.math.BigDecimal.javaBigDecimal2bigDecimal(
                javaBigDecimal);
        Decimal set = decimal.set(scalaBigDecimal, 10, 5);
        SparkPredicateSerializer sparkPredicateSerializer = new SparkPredicateSerializer(
                "testDecimal", null, null);
