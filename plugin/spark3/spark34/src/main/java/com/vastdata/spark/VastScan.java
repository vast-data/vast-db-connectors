        ...
        implements Scan, SupportsReportStatistics, SupportsRuntimeV2Filtering
{
            ...
            Map<String, String> columnMasks)
    {
        ...
        LOG.warn("new VastScan: table={}, scanBuilderID={}, scanID={}",
    ...
    {
        if (verbose) {
            LOG.warn(format("%s estimateStatistics", this),
                    new Exception("VERBOSE SCAN"));
        }
        else {
            ...
            TableLevelStatistics statistics)
    {
        ...
        if (sizeStatistics.isPresent()) {
            final int tableSchemaDefaultSize = this.table
                    .schema()
                    .defaultSize();
            final float scanSchemaSize = (float) this
                    .readSchema()
                    .defaultSize();
            final long currentSize = sizeStatistics.getAsLong();
            final long newSize = getNewSize(tableSchemaDefaultSize,
                    scanSchemaSize, currentSize);
