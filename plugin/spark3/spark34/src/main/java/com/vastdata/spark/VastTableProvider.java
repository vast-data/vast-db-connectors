        ...
        implements SupportsCatalogOptions
{
    ...
    public StructType inferSchema(CaseInsensitiveStringMap options)
    {
        ...
        return new StructType(
                new StructField[] {createStructField("a", DataTypes.StringType,
                        true),
            ...
            Map<String, String> properties)
    {
        throw new RuntimeException(
                String.format("should not get here - getTable: %s, %s, %s",
                        schema, partitioning, properties));
    }
    ...
    public Identifier extractIdentifier(CaseInsensitiveStringMap options)
    {
        ...
        try {
            ...
            ParsedURL parsedURL = ParsedURL.of(
            ...
            String[] namespace = Arrays.copyOfRange(fullSchemaParts, 1,
                    fullSchemaParts.length);
    ...
    @Override
    public Optional<String> extractTimeTravelTimestamp(
    ...
    @Override
    public Optional<String> extractTimeTravelVersion(
            CaseInsensitiveStringMap options)
    {
