        ...
        implements SupportsRead, SupportsWrite, SupportsDeleteV2, SupportsRowLevelOperations, SupportsReportStatistics
{
    ...
    public VastTable(String schemaName, String tableName,  String handleID, StructType schema, Supplier<VastClient> clientSupplier, boolean forImportData)
    {
    ...
    public ScanBuilder newScanBuilder(CaseInsensitiveStringMap options)
    {
        ...
        return new VastScanBuilder(this, options);
    }
