    ...
    implements FunctionCatalog
{
    ...
    private final Map<String, Function<VastConfig, UnboundFunction>> functions = new HashMap<>(3);
    private final VastConfig config;

    public VastNDBFunctionsCatalog(VastConfig config) {
        this.config = config;
    }
            ...
            throws NoSuchFunctionException
    {
        ...
        Function<VastConfig, UnboundFunction> function = functions.get(ident.name().toLowerCase(Locale.getDefault()));
        if (function != null) {
