...
public class NDBStrategy extends SparkStrategy
{
    ...
    public static final List<SparkPlan> EMPTY_RESULT_SEQ = List.<SparkPlan>empty();
    ...
    {
        return scala.collection.JavaConverters.collectionAsScalaIterable(Collections.singletonList(plan)).toList();
    }
}
