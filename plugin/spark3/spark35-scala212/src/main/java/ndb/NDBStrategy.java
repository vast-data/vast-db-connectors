...
public class NDBStrategy extends SparkStrategy
{
    ...
    public static final List<SparkPlan> EMPTY_RESULT_SEQ = List.empty();
    ...
    {
        return scala.collection.JavaConverters.collectionAsScalaIterable(Collections.singletonList(plan)).toSeq();
    }
}
