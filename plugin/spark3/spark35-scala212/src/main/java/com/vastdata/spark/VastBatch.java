        ...
        implements Batch
{
    ...
    public PartitionReaderFactory createReaderFactory()
    {
        if (vastPartitionReaderFactory == null) {
            ...
            vastPartitionReaderFactory = new VastPartitionReaderFactory(supplyTransaction(), batchID, vastConfig, table.getTableMD().schemaName, table.getTableMD().tableName, schema, limit, predicates);
