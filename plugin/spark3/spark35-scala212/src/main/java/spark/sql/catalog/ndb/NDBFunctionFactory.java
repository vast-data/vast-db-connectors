...
{
    private static final EnumMap<NDBFunction, Supplier<UnboundFunction>> implMap = new EnumMap<>(
            NDBFunction.class);
    ...
    static {
        ...
        implMap.put(NDBFunction.ROLLBACK_TX,
                NDBRollbackTransactionFunction::new);
    }
