        ...
        implements ColumnStatistics
{
    ...
    public ColumnLevelStatistics(OptionalLong distinctCount, Optional<Object> min, Optional<Object> max,
                                 OptionalLong nullCount, OptionalLong avgLen, OptionalLong maxLen)
    {
