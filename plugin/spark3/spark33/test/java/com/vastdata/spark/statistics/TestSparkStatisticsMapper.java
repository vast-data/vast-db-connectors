...
public class TestSparkStatisticsMapper
{
    ...
    public void setup()
    {
        ...
        NDB.init(getMockServerReadyVastConfig());
    }
    ...
    public void testFilterEstimation()
    {
        ...
        DataSourceV2ScanRelation v2ScanRelation = new DataSourceV2ScanRelation(v2rel, tableMock.newScanBuilder(empty).build(), v2rel.output(), Option.empty());
