...
import static org.apache.iceberg.util.DateTimeUtil.microsToDays;
import static spark.sql.catalog.ndb.PartitionFunctionUtils.applyRecurse;

public class DaysFunction
        extends org.apache.iceberg.spark.functions.DaysFunction
{
    ...
    public static Optional<Predicate> apply(Predicate predicate,
            NamedReference newRef)
    {
        return applyRecurse(predicate, newRef, DaysFunction::internalApply);
    }
