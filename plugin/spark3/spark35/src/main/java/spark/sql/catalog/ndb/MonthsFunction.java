...
import static org.apache.iceberg.util.DateTimeUtil.daysToMonths;
import static org.apache.iceberg.util.DateTimeUtil.microsToMonths;
import static spark.sql.catalog.ndb.PartitionFunctionUtils.applyRecurse;

public class MonthsFunction
        extends org.apache.iceberg.spark.functions.MonthsFunction
{
    ...
    public static Optional<Predicate> apply(Predicate predicate,
            NamedReference newRef)
    {
        return applyRecurse(predicate, newRef, MonthsFunction::internalApply);
    }
