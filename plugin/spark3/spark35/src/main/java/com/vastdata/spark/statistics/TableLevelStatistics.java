...
public class TableLevelStatistics
        implements Statistics
{
    ...
    public TableLevelStatistics(OptionalLong size, OptionalLong rows,
    ...
    {
        return new TableLevelStatistics(OptionalLong.of(size),
                OptionalLong.of(rows), new HashMap<>());
    }
    ...
    {
        return MoreObjects.toStringHelper(this).add("rows", rows).add("size",
                size).add("columnStats", columnStats).toString();
    }
}
