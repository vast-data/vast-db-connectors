...
public final class StatsUtils
{
    ...
    {
        OptionalLong sizeInBytes = OptionalLong.of(
                fullStats.sizeInBytes().longValue());
        OptionalLong rowCount = fullStats.rowCount().isEmpty() ?
                OptionalLong.empty() :
                OptionalLong.of(fullStats.rowCount().get().longValue());
        ...
        fullStats.attributeStats().foreach(entry -> {
            ...
            return columnStats.put(ref, stat);
        });
