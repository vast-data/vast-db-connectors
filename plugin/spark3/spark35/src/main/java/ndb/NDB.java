...
public final class NDB
        extends NDBCommon
{
    static final NDBTransactionsRegistry QUERY_TRANSACTIONS_REGISTRY;
    ...
    static {
        ...
        QUERY_TRANSACTIONS_REGISTRY = new NDBTransactionsRegistry(
                new NDBTransactionCloser(
                        () -> VastSparkTransactionsManager.getInstance(
    ...
    public static NDBTransactionsRegistry getTxRegistry()
    {
        return QUERY_TRANSACTIONS_REGISTRY;
    }
            ...
            String engineVersion)
    {
        ...
        int queryDataRowsPerPage = conf.getInt(
                "spark.ndb.query_data_rows_per_page", 100000);
        ...
        boolean enableSortedProjections = conf.getBoolean(
                "spark.ndb.enable_sorted_projections", false);
        boolean reportPartitioning = conf.getBoolean(
                "spark.ndb.report_partitioning", false);
        ...
        int dynamicFilterMaxValuesThreshold = conf.getInt(
                "spark.ndb.dynamic_filter_max_values_threshold", 1000);
        ...
        boolean enableAccessControl = conf.getBoolean(
                "spark.ndb." + VastConfig.ENABLE_ACCESS_CONTROL, true);
        ...
        boolean enableRowColumnSecurity = conf.getBoolean(
                "spark.ndb." + VastConfig.ENABLE_ROW_COLUMN_SECURITY, true);
        long insertPartitionSize = conf.getLong(
                "spark.ndb.insert_partition_size", 8 * 1024 * 1024);
        boolean insertExactPartitioning = conf.getBoolean(
                "spark.ndb.insert_exact_partitioning", true);
        ...
        return new VastConfig()
                ...
                .setReportPartitioning(reportPartitioning)
                ...
                .setInsertPartitionSize(insertPartitionSize)
                .setInsertExactPartitioning(insertExactPartitioning);
    }
