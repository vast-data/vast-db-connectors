...
public class VastViewMetadata
{
    ...
    public static final Field SQL_FIELD = new Field(FIELD_SQL,
            FieldType.nullable(ArrowType.Utf8.INSTANCE), null);
    public static final Field COLUMN_ALIASES_FIELD = new Field(
            FIELD_COLUMN_ALIASES, FieldType.nullable(ArrowType.List.INSTANCE),
            Collections.singletonList(new Field(NESTED_ARR_FIELD_NAME,
                    FieldType.nullable(ArrowType.Utf8.INSTANCE), null)));
    public static final Field COLUMN_COMMENTS_FIELD = new Field(
            FIELD_COLUMN_COMMENTS, FieldType.nullable(ArrowType.List.INSTANCE),
            Collections.singletonList(new Field(NESTED_ARR_FIELD_NAME,
                    FieldType.nullable(ArrowType.Utf8.INSTANCE), null)));
    public static final Field COMMENT_FIELD = new Field(FIELD_COMMENT,
            FieldType.nullable(ArrowType.Utf8.INSTANCE), null);

    static {
        final Field currentCatalogField = new Field(FIELD_CURRENT_CATALOG,
                FieldType.nullable(ArrowType.Utf8.INSTANCE), null);

        final Field currentNamespaceField = new Field(FIELD_CURRENT_NAMESPACE,
                FieldType.nullable(ArrowType.List.INSTANCE),
                Collections.singletonList(new Field(NESTED_ARR_FIELD_NAME,
                        FieldType.nullable(ArrowType.Utf8.INSTANCE), null)));
        final Field queryColumnNamesField = new Field(FIELD_QUERY_COLUMN_NAMES,
                FieldType.nullable(ArrowType.List.INSTANCE),
                Collections.singletonList(new Field(NESTED_ARR_FIELD_NAME,
                        FieldType.nullable(ArrowType.Utf8.INSTANCE), null)));
        ...
        final List<Field> mapChildFields = Collections.singletonList(
                new Field(MapVector.DATA_VECTOR_NAME,
                        ...
                        asList(new Field(MapVector.KEY_NAME,
                                FieldType.notNullable(ArrowType.Utf8.INSTANCE),
                                null), new Field(MapVector.VALUE_NAME,
                                FieldType.nullable(ArrowType.Utf8.INSTANCE),
                                null))));
        final Field propertiesField = new Field(FIELD_PROPERTIES,
                FieldType.nullable(new ArrowType.Map(false)), mapChildFields);
        VIEW_DETAILS_SCHEMA = new Schema(
                asList(SQL_FIELD, currentCatalogField, COMMENT_FIELD,
                        currentNamespaceField, queryColumnNamesField,
                        COLUMN_ALIASES_FIELD, COLUMN_COMMENTS_FIELD,
                        propertiesField));
    }
    ...
    public VastViewMetadata(String schemaName, String viewName,
            VectorSchemaRoot metadata, Schema schema)
    {
    ...
    {
        return VastViewMetadata.VIEW_DETAILS_SCHEMA
                .getFields()
                .indexOf(VastViewMetadata.VIEW_DETAILS_SCHEMA.findField(
                        fieldName));
    }
