...
public final class VastViewDetails
{
    ...
    public VastViewDetails(final String originalSql, final String catalog,
            final String schema, final List<Field> columns,
            final Optional<String> comment, final String owner,
