 ...
 */
package com.vastdata.client.buffering.delete;
...
public class BufferedDeleteTaskFactory
        extends BufferedRowIdBasedWriteTaskFactory
{
    ...
    public BufferedDeleteTaskFactory(VastClient client, VastTransaction tx,
    ...
    {
        client.deleteRows(tx, schema, table, vsr, dataEndpoint, maxRowsPerRpc,
                extraQueryParams,
                endUser);
    }
}
