...
public class VastMetadataUtils
{
    ...
    // TODO: as Trino is case insensitive, this is doing case insensitive compare right now
    //       But Spark can be case sensitive.  So this should be rethought when Spark support is added
    //       to elysium
