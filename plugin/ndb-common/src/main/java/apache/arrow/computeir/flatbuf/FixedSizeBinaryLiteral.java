...
public final class FixedSizeBinaryLiteral extends Table {
  ...
  public static FixedSizeBinaryLiteral getRootAsFixedSizeBinaryLiteral(ByteBuffer _bb, FixedSizeBinaryLiteral obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static int createFixedSizeBinaryLiteral(FlatBufferBuilder builder,
      int valueOffset) {
  ...
  public static int endFixedSizeBinaryLiteral(FlatBufferBuilder builder) {
  ...
  public static final class Vector extends BaseVector {
    ...
    public FixedSizeBinaryLiteral get(int j) { return get(new FixedSizeBinaryLiteral(), j); }
    public FixedSizeBinaryLiteral get(FixedSizeBinaryLiteral obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
